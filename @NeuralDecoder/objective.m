...
function [objective, logL, kernel, transformed_signal] = objective(self, signal, params)
  %% Description:
  ...
  %
  %% See Also: NeuralDecoder/loglikelihood, NeuralDecoder/encode
